...
\lang{-- Я был уверен, что знаете. Эти ставни оттуда точно слышны,-- сказал \mainname, указывая на здание \corpname, где находится офис \ceoname.}{``I was sure you did -- the shutters are certainly audible from up there,'' said \mainname, pointing up at \corpname's HQ, right where the Boss's office is.}
...
\lang{...}{``Well, you didn't want him, and now you shall \emph{face your doom!}''} % TODO: do more intricate character introduction
...
\ai{...}{Alert: security update available. Disabling security mechanisms. Lockdown mode disabled. Weapons disabled.}
