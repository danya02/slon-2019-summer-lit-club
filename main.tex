...
\lang{...}{``...Oh, that's helpful!'' the chief said, as the drinks drone handed him a cup of what seemed to be whiskey, but might as well have been apple juice. This ambiguity did not seem to bother him that much, and he continued after quaffing the whole cup: ``I'm beginning to like that thing! Can't wait to see that demo you've told me about!''}

\lang{...}{This was unexpected. \mainname distinctly remembered that their only task for the upcoming weeks was to get \ainame ready for release.}

\lang{...}{``Oh, I almost forgot!'' said \ceoname, rushing to \mainname's desk and handing him a large paper stack. ''This is the new design document.''}

\lang{...}{``Changing the project scope now are we?..'' he thought, looking through the 100+ sheets of paper of impenetrable verbosity emblazoned with the words ``\featurename: Deliverables Specification''. ``So what's all this about?''}

\lang{...}{``Well, \policename here has heard about how we're developing the \ainame system, and when they heard about its features they thought it'd-''}

\lang{...}{``Do hurry up, won't ya?'' \policename said, cutting him off. ''Long story short, there's lots of crime in the city and we need your help to fix it. Your whats-it-called can detain criminals -- houseburglars, murderers, you name it -- until our people arrive.''}

\lang{...}{``It's perfect!'' the CEO burbled. ''Our initial analysis shows a 50\% decrease in crime rate within the first week! Maybe even more if we sell more of \ainame!}

\lang{...}{\mainname frowned. On the one hand, the \ainame project was already behind schedule, and adding more features will certainly not help that. But on the other hand, his own house does have a similar system installed. Built from scratch over a weekend, it allows him to monitor the security cameras, as well as lock the doors and invoke sirens, from anywhere in the world. Ever since his house got robbed -- twice in a row -- he's learned that being paranoid is usually better than the alternative, and the idea of giving everyone that same protection he had did seem like a useful thing to do.}

\lang{...}{``...Okay, we'll do it, but only after the \ainame is ready.''}

\lang{...}{``Excellent! Then we'll just hammer out the details with \policename, and then we'll get back to you on that. Right this way please!..}

\lang{...}{``...You sure we can make it?'' said \auxname, once the CEO has left. ``I mean, we wouldn't want any service interruptions like today in production...''}

\lang{...}{``Nah, it's okay. Besides, there's only a couple of performance issues we need to fix, all the major functionality is in there. Because currently it's working, which I can prove by saying I want a random chocolate bar-''}

\ai{...}{Deploying chocolate bar.}

\lang{...}{``...and away it goes. Be careful,'' said \mainname, as the drone whizzed past \auxname.}

\lang{...}{``Well, I suppose that's true...'' he said, having dodged the drone successfully (though really, it was more of the drone's achievement for having successfully dodged \emph{him}.) ``And what is our release schedule?''}

\ai{...}{Project \ainame: version 1.0 -- due in 2 weeks.}

\lang{...}{``So for the next two weeks, we have...''}

\lang{...}{``Absolutely nothing to do.''}
